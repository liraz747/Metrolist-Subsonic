    ...
    override fun onGetSearchResult(
        ...
        return scope.future(Dispatchers.IO) {
            ...
            try {
                ...
                // YouTube search is not available with Subsonic
                // Subsonic search could be implemented here in the future
                try {
                    val onlineResults = emptyList<Any>()  // YouTube search disabled
                    ...
                    // YouTube search disabled - no online results to process
        ...
        scope.future {
            ...
            when (path.firstOrNull()) {
                ...
                MusicService.SEARCH -> {
                    ...
                    val targetIndex = searchResults.indexOfFirst { it.song.id == songId }
