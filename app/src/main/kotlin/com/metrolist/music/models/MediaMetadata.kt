...
// Extension function for Subsonic Child (song) to MediaMetadata
fun com.metrolist.subsonic.models.Child.toMediaMetadata() =
    MediaMetadata(
        id = id,
        title = title,
        ...
        duration = duration ?: -1,
        thumbnailUrl = coverArt?.let { "subsonic://coverArt/$it" },
        album = album?.let {
            MediaMetadata.Album(
                id = albumId ?: "",
                title = it,
