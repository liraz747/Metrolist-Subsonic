                    ...
                    modifier = Modifier.clickable {
                        ...
                        coroutineScope.launch(Dispatchers.IO) {
                            ...
                            songs.reversed().forEach{
                                ...
                                // Subsonic: Online search disabled for Subsonic
                                // TODO: Reimplement with Subsonic search if needed
                                coroutineScope.launch {
                                    songsIdx += 1  // Skip this song
                                    /*
                                    try {
                                        // Subsonic: YouTube.search(query, YouTube.SearchFilter.FILTER_SONG)
                                            .onSuccess { result ->
                    ...
                    modifier = Modifier.clickable {
                        coroutineScope.launch(Dispatchers.IO) {
                            ...
                            songs.reversed().forEach{
                                ...
                                // Subsonic: Remote YouTube search disabled
                                songsIdx += 1
                                if (songsIdx.toInt() == songsTot.toInt() - 1) {
                                    onProgressStart(false)
                                }
