...
android {
    // Keep original namespace so existing package imports (R, BuildConfig) remain valid
    namespace = "com.metrolist.music"
    compileSdk = 36

    defaultConfig {
        // Distinct applicationId to allow side-by-side install with regular Metrolist
    ...
    buildTypes {
        ...
        debug {
            // Use explicit debug suffix for subsonic variant
